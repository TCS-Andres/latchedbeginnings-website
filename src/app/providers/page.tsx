            ...
            {cards.map((card, i) => {
              ...
              return (
                <Reveal as="article" key={card.href} delay={i * 90}>
                  <div className="flex h-full flex-col rounded-[1.75rem] border border-blush-200 bg-white p-8 transition-shadow duration-300 hover:shadow-[0_24px_50px_-30px_rgba(210,116,90,0.6)] sm:p-10">
